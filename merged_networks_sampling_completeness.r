#####################################################
### Calculating sampling completeness for merged networks
...
df_flipped_LKA <- subset(dat1, Site == "Likupang" & Quadrat == "LKA",
...
write.csv(LKAmat1_flipped, file = "LKAmerged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LKA__dataset <- read.csv("LKAmerged_network_sampling_completeness.csv", header=T)
...
df_flipped_LKB <- subset(dat1, Site == "Likupang" & Quadrat == "LKB",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LKBmat1_flipped, file = "LKBmerged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LKB__dataset <- read.csv("LKBmerged_network_sampling_completeness.csv", header=T)
...
df_flipped_LKC <- subset(dat1, Site == "Likupang" & Quadrat == "LKC",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LKCmat1_flipped, file = "LKCmerged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LKC__dataset <- read.csv("LKCmerged_network_sampling_completeness.csv", header=T)
...
#### LK4 with video + vegetation search

df_flipped_LK4 <- subset(dat1, Site == "Likupang" & Quadrat == "LK4",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK4mat1_flipped, file = "LK4merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK4_video_dataset <- read.csv("LK4merged_network_sampling_completeness.csv", header=T)
...
#### LK5 with video + vegetation search

df_flipped_LK5 <- subset(dat1, Site == "Likupang" & Quadrat == "LK5",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK5mat1_flipped, file = "LK5merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK5_video_dataset <- read.csv("LK5merged_network_sampling_completeness.csv", header=T)
...
#### LK6 with video + vegetation search

df_flipped_LK6 <- subset(dat1, Site == "Likupang" & Quadrat == "LK6",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK6mat1_flipped, file = "LK6merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK6_video_dataset <- read.csv("LK6merged_network_sampling_completeness.csv", header=T)
...
#### LK7 with video + vegetation search

df_flipped_LK7 <- subset(dat1, Site == "Likupang" & Quadrat == "LK7",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK7mat1_flipped, file = "LK7merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK7_video_dataset <- read.csv("LK7merged_network_sampling_completeness.csv", header=T)
...
#### LK8 with video + vegetation search

df_flipped_LK8 <- subset(dat1, Site == "Likupang" & Quadrat == "LK8",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK8mat1_flipped, file = "LK8merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK8_video_dataset <- read.csv("LK8merged_network_sampling_completeness.csv", header=T)
...
#### LK9 with video + vegetation search

df_flipped_LK9 <- subset(dat1, Site == "Likupang" & Quadrat == "LK9",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK9mat1_flipped, file = "LK9merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK9_video_dataset <- read.csv("LK9merged_network_sampling_completeness.csv", header=T)
...
#### LK10 with video + vegetation search

df_flipped_LK10 <- subset(dat1, Site == "Likupang" & Quadrat == "LK10",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK10mat1_flipped, file = "LK10merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK10_video_dataset <- read.csv("LK10merged_network_sampling_completeness.csv", header=T)
...
#### LK11 with video + vegetation search

df_flipped_LK11 <- subset(dat1, Site == "Likupang" & Quadrat == "LK11",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK11mat1_flipped, file = "LK11merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK11_video_dataset <- read.csv("LK11merged_network_sampling_completeness.csv", header=T)
...
#### LK12 with video + vegetation search

df_flipped_LK12 <- subset(dat1, Site == "Likupang" & Quadrat == "LK12",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK12mat1_flipped, file = "LK12merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK12_video_dataset <- read.csv("LK12merged_network_sampling_completeness.csv", header=T)
...
#### LK13 with video + vegetation search

df_flipped_LK13 <- subset(dat1, Site == "Likupang" & Quadrat == "LK13",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK13mat1_flipped, file = "LK13merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK13_video_dataset <- read.csv("LK13merged_network_sampling_completeness.csv", header=T)
...
#### LK14 with video + vegetation search

df_flipped_LK14 <- subset(dat1, Site == "Likupang" & Quadrat == "LK14",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK14mat1_flipped, file = "LK14merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK14_video_dataset <- read.csv("LK14merged_network_sampling_completeness.csv", header=T)
...
#### LK15 with video + vegetation search

df_flipped_LK15 <- subset(dat1, Site == "Likupang" & Quadrat == "LK15",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK15mat1_flipped, file = "LK15merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK15_video_dataset <- read.csv("LK15merged_network_sampling_completeness.csv", header=T)
...
#### LK16 with video + vegetation search

df_flipped_LK16 <- subset(dat1, Site == "Likupang" & Quadrat == "LK16",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK16mat1_flipped, file = "LK16merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK16_video_dataset <- read.csv("LK16merged_network_sampling_completeness.csv", header=T)
...
#### LK17 with video + vegetation search

df_flipped_LK17 <- subset(dat1, Site == "Likupang" & Quadrat == "LK17",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(LK17mat1_flipped, file = "LK17merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK17_video_dataset <- read.csv("LK17merged_network_sampling_completeness.csv", header=T)
...
#### TW1 with video + vegetation search

df_flipped_TW1 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW1",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW1mat1_flipped, file = "TW1merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW1_video_dataset <- read.csv("TW1merged_network_sampling_completeness.csv", header=T)
...
#### TW2 with video + vegetation search

df_flipped_TW2 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW2",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW2mat1_flipped, file = "TW2merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW2_video_dataset <- read.csv("TW2merged_network_sampling_completeness.csv", header=T)
...
#### TW3 with video + vegetation search

df_flipped_TW3 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW3",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW3mat1_flipped, file = "TW3merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW3_video_dataset <- read.csv("TW3merged_network_sampling_completeness.csv", header=T)
...
#### TW4 with video + vegetation search

df_flipped_TW4 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW4",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW4mat1_flipped, file = "TW4merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW4_video_dataset <- read.csv("TW4merged_network_sampling_completeness.csv", header=T)
...
#### TW5 with video + vegetation search

df_flipped_TW5 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW5",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW5mat1_flipped, file = "TW5merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW5_video_dataset <- read.csv("TW5merged_network_sampling_completeness.csv", header=T)
...
#### TW6 with video + vegetation search

df_flipped_TW6 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW6",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW6mat1_flipped, file = "TW6merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW6_video_dataset <- read.csv("TW6merged_network_sampling_completeness.csv", header=T)
...
#### TW7 with video + vegetation search

df_flipped_TW7 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW7",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW7mat1_flipped, file = "TW7merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW7_video_dataset <- read.csv("TW7merged_network_sampling_completeness.csv", header=T)
...
#### TW8 with video + vegetation search

df_flipped_TW8 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW8",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW8mat1_flipped, file = "TW8merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW8_video_dataset <- read.csv("TW8merged_network_sampling_completeness.csv", header=T)
...
#### TW9 with video + vegetation search

df_flipped_TW9 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW9",
                         select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW9mat1_flipped, file = "TW9merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW9_video_dataset <- read.csv("TW9merged_network_sampling_completeness.csv", header=T)
...
#### TW10 with video + vegetation search

df_flipped_TW10 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW10",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW10mat1_flipped, file = "TW10merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW10_video_dataset <- read.csv("TW10merged_network_sampling_completeness.csv", header=T)
...
#### TW11 with video + vegetation search

df_flipped_TW11 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW11",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW11mat1_flipped, file = "TW11merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW11_video_dataset <- read.csv("TW11merged_network_sampling_completeness.csv", header=T)
...
#### TW12 with video + vegetation search

df_flipped_TW12 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW12",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW12mat1_flipped, file = "TW12merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW12_video_dataset <- read.csv("TW12merged_network_sampling_completeness.csv", header=T)
...
#### TW13 with video + vegetation search

df_flipped_TW13 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW13",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW13mat1_flipped, file = "TW13merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW13_video_dataset <- read.csv("TW13merged_network_sampling_completeness.csv", header=T)
...
#### TW14 with video + vegetation search

df_flipped_TW14 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW14",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW14mat1_flipped, file = "TW14merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW14_video_dataset <- read.csv("TW14merged_network_sampling_completeness.csv", header=T)
...
#### TW15 with video + vegetation search

df_flipped_TW15 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW15",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW15mat1_flipped, file = "TW15merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW15_video_dataset <- read.csv("TW15merged_network_sampling_completeness.csv", header=T)
...
#### TW16 with video + vegetation search

df_flipped_TW16 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW16",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW16mat1_flipped, file = "TW16merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW16_video_dataset <- read.csv("TW16merged_network_sampling_completeness.csv", header=T)
...
#### TW17 with video + vegetation search

df_flipped_TW17 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW17",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW17mat1_flipped, file = "TW17merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW17_video_dataset <- read.csv("TW17merged_network_sampling_completeness.csv", header=T)
...
#### TW18 with video + vegetation search

df_flipped_TW18 <- subset(dat1, Site == "Tiwoho" & Quadrat == "TW18",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))
...
# export matrix as csv
write.csv(TW18mat1_flipped, file = "TW18merged_network_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW18_video_dataset <- read.csv("TW18merged_network_sampling_completeness.csv", header=T)
