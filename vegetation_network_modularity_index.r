...
write.csv(LKAmat1_, file = "LKA_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LKA__dataset <- read.csv("LKA_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LKBmat1_, file = "LKB_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LKB__dataset <- read.csv("LKB_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LKCmat1_, file = "LKC_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LKC__dataset <- read.csv("LKC_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK4mat1_, file = "LK4_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK4__dataset <- read.csv("LK4_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK5mat1_, file = "LK5_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK5__dataset <- read.csv("LK5_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK6mat1_, file = "LK6_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK6__dataset <- read.csv("LK6_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK7mat1_, file = "LK7_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK7__dataset <- read.csv("LK7_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK8mat1_, file = "LK8_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK8__dataset <- read.csv("LK8_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK9mat1_, file = "LK9_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK9__dataset <- read.csv("LK9_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK10mat1_, file = "LK10_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK10__dataset <- read.csv("LK10_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK11mat1_, file = "LK11_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK11__dataset <- read.csv("LK11_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK12mat1_, file = "LK12_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK12__dataset <- read.csv("LK12_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK13mat1_, file = "LK13_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK13__dataset <- read.csv("LK13_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK14mat1_, file = "LK14_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK14__dataset <- read.csv("LK14_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK15mat1_, file = "LK15_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK15__dataset <- read.csv("LK15_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK16mat1_, file = "LK16_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK16__dataset <- read.csv("LK16_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(LK17mat1_, file = "LK17_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK17__dataset <- read.csv("LK17_vegetation_sampling_modularity.csv", header=T)
...
df__LK18 <- subset(dat1, Site == "Likupang" & Quadrat == "LK18"
                   & Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video",
                   select=c(Network_lower_level_shorthand, Network_upper_level_shorthand))

# convert edge list to matrix
LK18m1_ <- table( df__LK18 )
(LK18mat1_ <- unclass(LK18m1_))
class(LK18mat1_)

# export matrix as csv
write.csv(LK18mat1_, file = "LK18_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
LK18__dataset <- read.csv("LK18_vegetation_sampling_modularity.csv", header=T)


### delete first row to ensure all numeric

LK18__matrix <- LK18__dataset[,-1]

### Modularity Q
mod_LK18__matrix <- computeModules(web=LK18__matrix, steps=1E8)

mod_LK18__matrix@likelihood

### Creating an index from Q accounting for network size
nulls <- nullmodel(LK18__matrix, N=100, Method="r2d")
modules.nulls <- sapply(nulls, computeModules)
like.nulls <- sapply(modules.nulls, function(x) x@likelihood)
(z <- (mod_LK18__matrix@likelihood - mean(like.nulls))/sd(like.nulls))
...
# export matrix as csv
write.csv(TW1mat1_, file = "TW1_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW1__dataset <- read.csv("TW1_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW2mat1_, file = "TW2_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW2__dataset <- read.csv("TW2_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW3mat1_, file = "TW3_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW3__dataset <- read.csv("TW3_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW4mat1_, file = "TW4_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW4__dataset <- read.csv("TW4_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW5mat1_, file = "TW5_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW5__dataset <- read.csv("TW5_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW6mat1_, file = "TW6_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW6__dataset <- read.csv("TW6_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW7mat1_, file = "TW7_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW7__dataset <- read.csv("TW7_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW8mat1_, file = "TW8_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW8__dataset <- read.csv("TW8_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW9mat1_, file = "TW9_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW9__dataset <- read.csv("TW9_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW10mat1_, file = "TW10_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW10__dataset <- read.csv("TW10_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW11mat1_, file = "TW11_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW11__dataset <- read.csv("TW11_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW12mat1_, file = "TW12_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW12__dataset <- read.csv("TW12_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW13mat1_, file = "TW13_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW13__dataset <- read.csv("TW13_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW14mat1_, file = "TW14_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW14__dataset <- read.csv("TW14_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW15mat1_, file = "TW15_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW15__dataset <- read.csv("TW15_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW16mat1_, file = "TW16_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW16__dataset <- read.csv("TW16_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW17mat1_, file = "TW17_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW17__dataset <- read.csv("TW17_vegetation_sampling_modularity.csv", header=T)
...
# export matrix as csv
write.csv(TW18mat1_, file = "TW18_vegetation_sampling_modularity.csv")

## ----read_data----- previously exported matrix csv
TW18__dataset <- read.csv("TW18_vegetation_sampling_modularity.csv", header=T)
