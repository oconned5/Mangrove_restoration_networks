...
### CaCo_index and Foliage_projective_cover  highly correlated 
...
weighted_NODF_plus <- dfTiw$weighted_NODF + 0.0001
...
log_generality <- log10(dfTiw$generality.HL)
...
log10interaction_evenness <- log10(dfTiw$interaction_evenness)
...
##############################################
LogVulnerability <- log10(dfTiw$vulnerability.LL)
...
InverseVulnerability <- 1/dfTiw$vulnerability.LL
...
### gaussian for H2, trial different link functions
### identity
...
log10_Neg_H2 <-  log10(max(dfTiw$H2+1) - dfTiw$H2)
...
Inverse_Neg_H2 <-  1/(max(dfTiw$H2+1) - dfTiw$H2)
...
Sqrt_Neg_H2 <-  sqrt(max(dfTiw$H2+1) - dfTiw$H2)
...
plot(devresid_no._interactionsM7a ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactionsM7b ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactionsM7c ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactionsM8a ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactionsM8b ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactionsM8c ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactionsM8d ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactionsM8e ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactionsM9a ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactionsM9b ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactionsM9c ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_videoM7a ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_videoM7b ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_videoM7c ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_videoM8a ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_videoM8b ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_videoM8c ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_videoM8d ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_videoM8e ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_videoM9a ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_videoM9b ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_videoM9c ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_all_vegM7a ~ dfTiw$CaCo_index)
...
plot(devresid_no._interactions_all_vegM7c ~ dfTiw$CaCo_index)




### quasipoisson for number of vegetation interactions, trial different link functions
### identity
no._interactions_videoM8a <- glm(no._interactions_video ~ Treatment
                                 + CaCo_index 
                                 ,
...
Log10_modularity_index <- log10(dfTiw$modularity_index)
...
plot(devresid_number.of.species.HLM7b ~ dfTiw$CaCo_index)
...
plot(devresid_number.of.species.HLM7c ~ dfTiw$CaCo_index)
...
plot(devresid_number.of.species.HLM8a ~ dfTiw$CaCo_index)
...
plot(devresid_number.of.species.HLM8b ~ dfTiw$CaCo_index)
...
plot(devresid_number.of.species.HLM8c ~ dfTiw$CaCo_index)
...
plot(devresid_number.of.species.HLM8d ~ dfTiw$CaCo_index)
...
plot(devresid_number.of.species.HLM8e ~ dfTiw$CaCo_index)
...
plot(devresid_number.of.species.HLM9a ~ dfTiw$CaCo_index)
...
plot(devresid_number.of.species.HLM9b ~ dfTiw$CaCo_index)
...
plot(devresid_number.of.species.HLM9c ~ dfTiw$CaCo_index)
