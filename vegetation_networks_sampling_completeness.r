#####################################################
### Calculating sampling completeness for vegetation search networks
...
df_flipped_LKA <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
write.csv(LKAmat1_flipped, file = "LKA_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LKA__dataset <- read.csv("LKA_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LKB <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LKBmat1_flipped, file = "LKB_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LKB__dataset <- read.csv("LKB_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LKC <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LKCmat1_flipped, file = "LKC_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LKC__dataset <- read.csv("LKC_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK4 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK4mat1_flipped, file = "LK4_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK4_video_dataset <- read.csv("LK4_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK5 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK5mat1_flipped, file = "LK5_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK5_video_dataset <- read.csv("LK5_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK6 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK6mat1_flipped, file = "LK6_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK6_video_dataset <- read.csv("LK6_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK7 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK7mat1_flipped, file = "LK7_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK7_video_dataset <- read.csv("LK7_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK8 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK8mat1_flipped, file = "LK8_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK8_video_dataset <- read.csv("LK8_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK9 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK9mat1_flipped, file = "LK9_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK9_video_dataset <- read.csv("LK9_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK10 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK10mat1_flipped, file = "LK10_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK10_video_dataset <- read.csv("LK10_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK11 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK11mat1_flipped, file = "LK11_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK11_video_dataset <- read.csv("LK11_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK12 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK12mat1_flipped, file = "LK12_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK12_video_dataset <- read.csv("LK12_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK13 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK13mat1_flipped, file = "LK13_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK13_video_dataset <- read.csv("LK13_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK14 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK14mat1_flipped, file = "LK14_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK14_video_dataset <- read.csv("LK14_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK15 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK15mat1_flipped, file = "LK15_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK15_video_dataset <- read.csv("LK15_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK16 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK16mat1_flipped, file = "LK16_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK16_video_dataset <- read.csv("LK16_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_LK17 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(LK17mat1_flipped, file = "LK17_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK17_video_dataset <- read.csv("LK17_vegetation_sampling_completeness.csv", header=T)
...
#### LK18 with just vegetation

df_flipped_LK18 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
                            Site == "Likupang" & Quadrat == "LK18",
                          select=c(Network_upper_level_shorthand, Network_lower_level_shorthand))

# convert edge list to matrix
LK18m1_flipped <- table( df_flipped_LK18 )
(LK18mat1_flipped <- unclass(LK18m1_flipped))
class(LK18mat1_flipped)

# export matrix as csv
write.csv(LK18mat1_flipped, file = "LK18_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
LK18_video_dataset <- read.csv("LK18_vegetation_sampling_completeness.csv", header=T)


### delete first row to ensure all numeric

LK18_video_matrix <- LK18_video_dataset[,-1]

# remove zeros
#LK18_new_mtx <- LK18_video_matrix [which(rowSums(LK18_video_matrix) > 0), ]


LK18_video_comp <- SCw1(LK18_video_matrix)
LK18_video_comp

## ----estimator_flag1------ ##
LK18_video_comp1 <- SCw1(LK18_video_matrix, estimator="ACE")
LK18_video_comp1

LK18_video_comp2 <- SCw1(LK18_video_matrix, estimator=c("ACE","Chao1"))
LK18_video_comp2
...
df_flipped_TW1 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW1mat1_flipped, file = "TW1_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW1_video_dataset <- read.csv("TW1_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW2 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW2mat1_flipped, file = "TW2_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW2_video_dataset <- read.csv("TW2_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW3 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW3mat1_flipped, file = "TW3_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW3_video_dataset <- read.csv("TW3_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW4 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW4mat1_flipped, file = "TW4_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW4_video_dataset <- read.csv("TW4_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW5 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW5mat1_flipped, file = "TW5_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW5_video_dataset <- read.csv("TW5_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW6 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW6mat1_flipped, file = "TW6_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW6_video_dataset <- read.csv("TW6_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW7 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW7mat1_flipped, file = "TW7_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW7_video_dataset <- read.csv("TW7_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW8 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW8mat1_flipped, file = "TW8_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW8_video_dataset <- read.csv("TW8_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW9 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW9mat1_flipped, file = "TW9_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW9_video_dataset <- read.csv("TW9_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW10 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW10mat1_flipped, file = "TW10_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW10_video_dataset <- read.csv("TW10_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW11 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW11mat1_flipped, file = "TW11_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW11_video_dataset <- read.csv("TW11_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW12 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW12mat1_flipped, file = "TW12_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW12_video_dataset <- read.csv("TW12_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW13 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW13mat1_flipped, file = "TW13_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW13_video_dataset <- read.csv("TW13_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW14 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW14mat1_flipped, file = "TW14_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW14_video_dataset <- read.csv("TW14_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW15 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW15mat1_flipped, file = "TW15_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW15_video_dataset <- read.csv("TW15_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW16 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW16mat1_flipped, file = "TW16_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW16_video_dataset <- read.csv("TW16_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW17 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW17mat1_flipped, file = "TW17_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW17_video_dataset <- read.csv("TW17_vegetation_sampling_completeness.csv", header=T)
...
df_flipped_TW18 <- subset(dat1, Network_lower_level != "sediment" & Network_lower_level_shorthand != "DW" & Method != "Video" &
...
# export matrix as csv
write.csv(TW18mat1_flipped, file = "TW18_vegetation_sampling_completeness.csv")

## ----read_data----- previously exported matrix csv
TW18_video_dataset <- read.csv("TW18_vegetation_sampling_completeness.csv", header=T)
