###############################################################
## FINAL MODELS SELECTED FOR ANALYSES THE ANALYSES OF VIDEO NETWORK INDICES
...
# Read in the data
dat1<-read.csv(file.choose()) # Network_indices_video_data.csv
...
### gaussian for weighted_NODF
### identity link function
### terrible fit, but about as good as it gets
...
## inverse gaussian GLM, log link function
...
### GLM, family gaussian, inverse link
...
### gaussian for modularity_index, identity link functions
# poor fit
