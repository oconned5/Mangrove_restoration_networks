###############################################################
## TRIALING DIFFERENT MODEL FITS FOR THE ANALYSES OF MERGED NETWORK INDICES
...
### CaCo_index and Foliage_projective_cover e highly correlated 
...
### Poisson for number of interactions, trial different link functions
### identity
no._interactionsM7a <- glm(no._interactions ~ Treatment
                           + CaCo_index 
                           ,
                           family = poisson (link = "identity"),
                           data = dfLik)
summary(no._interactionsM7a)
AIC(no._interactionsM7a)
plot(no._interactionsM7a)

# R-squared
Model_R2no._interactionsM7a <- with(summary(no._interactionsM7a), 1 - deviance/null.deviance)
Model_R2no._interactionsM7a

pseudo.R2_no._interactionsM7a <- (no._interactionsM7a$null.deviance - no._interactionsM7a$deviance) /
  no._interactionsM7a$null.deviance
pseudo.R2_no._interactionsM7a

# overdispersion
overdispersion_no._interactionsM7a <- no._interactionsM7a$deviance / no._interactionsM7a$df.residual
overdispersion_no._interactionsM7a

# deviance residuals
devresid_no._interactionsM7a <- resid(no._interactionsM7a, type = "deviance")
plot(devresid_no._interactionsM7a ~ dfLik$CaCo_index)

### log
no._interactionsM7b <- glm(no._interactions ~ Treatment
                           + CaCo_index 
                           ,
                           family = poisson (link = "log"),
                           data = dfLik)
summary(no._interactionsM7b)
AIC(no._interactionsM7b)
plot(no._interactionsM7b)

# R-squared
Model_R2no._interactionsM7b <- with(summary(no._interactionsM7b), 1 - deviance/null.deviance)
Model_R2no._interactionsM7b

pseudo.R2_no._interactionsM7b <- (no._interactionsM7b$null.deviance - no._interactionsM7b$deviance) /
  no._interactionsM7b$null.deviance
pseudo.R2_no._interactionsM7b

# overdispersion
overdispersion_no._interactionsM7b <- no._interactionsM7b$deviance / no._interactionsM7b$df.residual
overdispersion_no._interactionsM7b

# deviance residuals
devresid_no._interactionsM7b <- resid(no._interactionsM7b, type = "deviance")
plot(devresid_no._interactionsM7b ~ dfLik$CaCo_index)

## sqrt
no._interactionsM7c <- glm(no._interactions ~ Treatment
                           + CaCo_index 
                           ,
                           family = poisson (link = "sqrt"),
                           data = dfLik)
summary(no._interactionsM7c)
AIC(no._interactionsM7c)
plot(no._interactionsM7c)

# R-squared
Model_R2no._interactionsM7c <- with(summary(no._interactionsM7c), 1 - deviance/null.deviance)
Model_R2no._interactionsM7c

pseudo.R2_no._interactionsM7c <- (no._interactionsM7c$null.deviance - no._interactionsM7c$deviance) /
  no._interactionsM7c$null.deviance
pseudo.R2_no._interactionsM7c

# overdispersion
overdispersion_no._interactionsM7c <- no._interactionsM7c$deviance / no._interactionsM7c$df.residual
overdispersion_no._interactionsM7c

# deviance residuals
devresid_no._interactionsM7c <- resid(no._interactionsM7c, type = "deviance")
plot(devresid_no._interactionsM7c ~ dfLik$CaCo_index)




### quasipoisson for number of interactions, trial different link functions
### identity
no._interactionsM8a <- glm(no._interactions ~ Treatment
                           + CaCo_index 
                           ,
                           family = quasipoisson (link = "identity"),
                           data = dfLik)
summary(no._interactionsM8a)
AIC(no._interactionsM8a)
plot(no._interactionsM8a)

# R-squared
Model_R2no._interactionsM8a <- with(summary(no._interactionsM8a), 1 - deviance/null.deviance)
Model_R2no._interactionsM8a

pseudo.R2_no._interactionsM8a <- (no._interactionsM8a$null.deviance - no._interactionsM8a$deviance) /
  no._interactionsM8a$null.deviance
pseudo.R2_no._interactionsM8a

# overdispersion
overdispersion_no._interactionsM8a <- no._interactionsM8a$deviance / no._interactionsM8a$df.residual
overdispersion_no._interactionsM8a

# deviance residuals
devresid_no._interactionsM8a <- resid(no._interactionsM8a, type = "deviance")
plot(devresid_no._interactionsM8a ~ dfLik$CaCo_index)
...
pseudo.R2_no._interactionsM8b <- (no._interactionsM8b$null.deviance - no._interactionsM8b$deviance) /
  no._interactionsM8b$null.deviance
pseudo.R2_no._interactionsM8b

# overdispersion
overdispersion_no._interactionsM8b <- no._interactionsM8b$deviance / no._interactionsM8b$df.residual
overdispersion_no._interactionsM8b

# deviance residuals
devresid_no._interactionsM8b <- resid(no._interactionsM8b, type = "deviance")
plot(devresid_no._interactionsM8b ~ dfLik$CaCo_index)

### logit
# fails
no._interactionsM8c <- glm(no._interactions ~ Treatment
                           + CaCo_index 
                           ,
                           family = quasipoisson (link = "logit"),
                           data = dfLik)
summary(no._interactionsM8c)
AIC(no._interactionsM8c)
plot(no._interactionsM8c)

# R-squared
Model_R2no._interactionsM8c <- with(summary(no._interactionsM8c), 1 - deviance/null.deviance)
Model_R2no._interactionsM8c

pseudo.R2_no._interactionsM8c <- (no._interactionsM8c$null.deviance - no._interactionsM8c$deviance) /
  no._interactionsM8c$null.deviance
pseudo.R2_no._interactionsM8c

# overdispersion
overdispersion_no._interactionsM8c <- no._interactionsM8c$deviance / no._interactionsM8c$df.residual
overdispersion_no._interactionsM8c

# deviance residuals
devresid_no._interactionsM8c <- resid(no._interactionsM8c, type = "deviance")
plot(devresid_no._interactionsM8c ~ dfLik$CaCo_index)

### probit
# fails
no._interactionsM8d <- glm(no._interactions ~ Treatment
                           + CaCo_index 
                           ,
                           family = quasipoisson (link = "probit"),
                           data = dfLik)
summary(no._interactionsM8d)
AIC(no._interactionsM8d)
plot(no._interactionsM8d)

# R-squared
Model_R2no._interactionsM8d <- with(summary(no._interactionsM8d), 1 - deviance/null.deviance)
Model_R2no._interactionsM8d

pseudo.R2_no._interactionsM8d <- (no._interactionsM8d$null.deviance - no._interactionsM8d$deviance) /
  no._interactionsM8d$null.deviance
pseudo.R2_no._interactionsM8d

# overdispersion
overdispersion_no._interactionsM8d <- no._interactionsM8d$deviance / no._interactionsM8d$df.residual
overdispersion_no._interactionsM8d

# deviance residuals
devresid_no._interactionsM8d <- resid(no._interactionsM8d, type = "deviance")
plot(devresid_no._interactionsM8d ~ dfLik$CaCo_index)


### cloglog
# fails
no._interactionsM8e <- glm(no._interactions ~ Treatment
                           + CaCo_index 
                           ,
                           family = quasipoisson (link = "cloglog"),
                           data = dfLik)
summary(no._interactionsM8e)
AIC(no._interactionsM8e)
plot(no._interactionsM8e)

# R-squared
Model_R2no._interactionsM8e <- with(summary(no._interactionsM8e), 1 - deviance/null.deviance)
Model_R2no._interactionsM8e

pseudo.R2_no._interactionsM8e <- (no._interactionsM8e$null.deviance - no._interactionsM8e$deviance) /
  no._interactionsM8e$null.deviance
pseudo.R2_no._interactionsM8e

# overdispersion
overdispersion_no._interactionsM8e <- no._interactionsM8e$deviance / no._interactionsM8e$df.residual
overdispersion_no._interactionsM8e

# deviance residuals
devresid_no._interactionsM8e <- resid(no._interactionsM8e, type = "deviance")
plot(devresid_no._interactionsM8e ~ dfLik$CaCo_index)
...
pseudo.R2_no._interactionsM9a <- (no._interactionsM9a$null.deviance - no._interactionsM9a$deviance) /
  no._interactionsM9a$null.deviance
pseudo.R2_no._interactionsM9a
...
### log
no._interactionsM9b <- glm.nb(no._interactions ~ Treatment
                              + CaCo_index 
                              , link = "log",
                              data = dfLik)
summary(no._interactionsM9b, cor = FALSE)
AIC(no._interactionsM9b)
plot(no._interactionsM9b)

# R-squared
Model_R2no._interactionsM9b <- with(summary(no._interactionsM9b), 1 - deviance/null.deviance)
Model_R2no._interactionsM9b

pseudo.R2_no._interactionsM9b <- (no._interactionsM9b$null.deviance - no._interactionsM9b$deviance) /
  no._interactionsM9b$null.deviance
pseudo.R2_no._interactionsM9b

# overdispersion
overdispersion_no._interactionsM9b <- no._interactionsM9b$deviance / no._interactionsM9b$df.residual
overdispersion_no._interactionsM9b

# deviance residuals
devresid_no._interactionsM9b <- resid(no._interactionsM9b, type = "deviance")
plot(devresid_no._interactionsM9b ~ dfLik$CaCo_index)

## sqrt
no._interactionsM9c <- glm.nb(no._interactions ~ Treatment
                              + CaCo_index 
                              , link = "sqrt",
                              data = dfLik)
summary(no._interactionsM9c, cor = FALSE)
AIC(no._interactionsM9c)
plot(no._interactionsM9c)

# R-squared
Model_R2no._interactionsM9c <- with(summary(no._interactionsM9c), 1 - deviance/null.deviance)
Model_R2no._interactionsM9c

pseudo.R2_no._interactionsM9c <- (no._interactionsM9c$null.deviance - no._interactionsM9c$deviance) /
  no._interactionsM9c$null.deviance
pseudo.R2_no._interactionsM9c

# overdispersion
overdispersion_no._interactionsM9c <- no._interactionsM9c$deviance / no._interactionsM9c$df.residual
overdispersion_no._interactionsM9c

# deviance residuals
devresid_no._interactionsM9c <- resid(no._interactionsM9c, type = "deviance")
plot(devresid_no._interactionsM9c ~ dfLik$CaCo_index)
...
### Poisson for number of video interactions, trial different link functions
### identity
no._interactions_videoM7a <- glm(no._interactions_video ~ Treatment
                                 + CaCo_index 
                                 ,
                                 family = poisson (link = "identity"),
                                 data = dfLik)
summary(no._interactions_videoM7a)
AIC(no._interactions_videoM7a)
plot(no._interactions_videoM7a)

# R-squared
Model_R2no._interactions_videoM7a <- with(summary(no._interactions_videoM7a), 1 - deviance/null.deviance)
Model_R2no._interactions_videoM7a

pseudo.R2_no._interactions_videoM7a <- (no._interactions_videoM7a$null.deviance - no._interactions_videoM7a$deviance) /
  no._interactions_videoM7a$null.deviance
pseudo.R2_no._interactions_videoM7a

# overdispersion
overdispersion_no._interactions_videoM7a <- no._interactions_videoM7a$deviance / no._interactions_videoM7a$df.residual
overdispersion_no._interactions_videoM7a

# deviance residuals
devresid_no._interactions_videoM7a <- resid(no._interactions_videoM7a, type = "deviance")
plot(devresid_no._interactions_videoM7a ~ dfLik$CaCo_index)

### log
no._interactions_videoM7b <- glm(no._interactions_video ~ Treatment
                                 + CaCo_index 
                                 ,
                                 family = poisson (link = "log"),
                                 data = dfLik)
summary(no._interactions_videoM7b)
AIC(no._interactions_videoM7b)
plot(no._interactions_videoM7b)

# R-squared
Model_R2no._interactions_videoM7b <- with(summary(no._interactions_videoM7b), 1 - deviance/null.deviance)
Model_R2no._interactions_videoM7b

pseudo.R2_no._interactions_videoM7b <- (no._interactions_videoM7b$null.deviance - no._interactions_videoM7b$deviance) /
  no._interactions_videoM7b$null.deviance
pseudo.R2_no._interactions_videoM7b

# overdispersion
overdispersion_no._interactions_videoM7b <- no._interactions_videoM7b$deviance / no._interactions_videoM7b$df.residual
overdispersion_no._interactions_videoM7b

# deviance residuals
devresid_no._interactions_videoM7b <- resid(no._interactions_videoM7b, type = "deviance")
plot(devresid_no._interactions_videoM7b ~ dfLik$CaCo_index)

## sqrt
no._interactions_videoM7c <- glm(no._interactions_video ~ Treatment
                                 + CaCo_index 
                                 ,
                                 family = poisson (link = "sqrt"),
                                 data = dfLik)
summary(no._interactions_videoM7c)
AIC(no._interactions_videoM7c)
plot(no._interactions_videoM7c)

# R-squared
Model_R2no._interactions_videoM7c <- with(summary(no._interactions_videoM7c), 1 - deviance/null.deviance)
Model_R2no._interactions_videoM7c

pseudo.R2_no._interactions_videoM7c <- (no._interactions_videoM7c$null.deviance - no._interactions_videoM7c$deviance) /
  no._interactions_videoM7c$null.deviance
pseudo.R2_no._interactions_videoM7c

# overdispersion
overdispersion_no._interactions_videoM7c <- no._interactions_videoM7c$deviance / no._interactions_videoM7c$df.residual
overdispersion_no._interactions_videoM7c

# deviance residuals
devresid_no._interactions_videoM7c <- resid(no._interactions_videoM7c, type = "deviance")
plot(devresid_no._interactions_videoM7c ~ dfLik$CaCo_index)




### quasipoisson for number of video interactions, trial different link functions
### identity
...
pseudo.R2_no._interactions_videoM8a <- (no._interactions_videoM8a$null.deviance - no._interactions_videoM8a$deviance) /
  no._interactions_videoM8a$null.deviance
pseudo.R2_no._interactions_videoM8a

# overdispersion
overdispersion_no._interactions_videoM8a <- no._interactions_videoM8a$deviance / no._interactions_videoM8a$df.residual
overdispersion_no._interactions_videoM8a

# deviance residuals
devresid_no._interactions_videoM8a <- resid(no._interactions_videoM8a, type = "deviance")
plot(devresid_no._interactions_videoM8a ~ dfLik$CaCo_index)

### log
no._interactions_videoM8b <- glm(no._interactions_video ~ Treatment
                                 + CaCo_index 
                                 ,
                                 family = quasipoisson (link = "log"),
                                 data = dfLik)
summary(no._interactions_videoM8b)
AIC(no._interactions_videoM8b)
plot(no._interactions_videoM8b)

# R-squared
Model_R2no._interactions_videoM8b <- with(summary(no._interactions_videoM8b), 1 - deviance/null.deviance)
Model_R2no._interactions_videoM8b

pseudo.R2_no._interactions_videoM8b <- (no._interactions_videoM8b$null.deviance - no._interactions_videoM8b$deviance) /
  no._interactions_videoM8b$null.deviance
pseudo.R2_no._interactions_videoM8b

# overdispersion
overdispersion_no._interactions_videoM8b <- no._interactions_videoM8b$deviance / no._interactions_videoM8b$df.residual
overdispersion_no._interactions_videoM8b

# deviance residuals
devresid_no._interactions_videoM8b <- resid(no._interactions_videoM8b, type = "deviance")
plot(devresid_no._interactions_videoM8b ~ dfLik$CaCo_index)

### logit
# fails
no._interactions_videoM8c <- glm(no._interactions_video ~ Treatment
                                 + CaCo_index 
                                 ,
                                 family = quasipoisson (link = "logit"),
                                 data = dfLik)
summary(no._interactions_videoM8c)
AIC(no._interactions_videoM8c)
plot(no._interactions_videoM8c)

# R-squared
Model_R2no._interactions_videoM8c <- with(summary(no._interactions_videoM8c), 1 - deviance/null.deviance)
Model_R2no._interactions_videoM8c

pseudo.R2_no._interactions_videoM8c <- (no._interactions_videoM8c$null.deviance - no._interactions_videoM8c$deviance) /
  no._interactions_videoM8c$null.deviance
pseudo.R2_no._interactions_videoM8c

# overdispersion
overdispersion_no._interactions_videoM8c <- no._interactions_videoM8c$deviance / no._interactions_videoM8c$df.residual
overdispersion_no._interactions_videoM8c

# deviance residuals
devresid_no._interactions_videoM8c <- resid(no._interactions_videoM8c, type = "deviance")
plot(devresid_no._interactions_videoM8c ~ dfLik$CaCo_index)

### probit
# fails
no._interactions_videoM8d <- glm(no._interactions_video ~ Treatment
                                 + CaCo_index 
                                 ,
                                 family = quasipoisson (link = "probit"),
                                 data = dfLik)
summary(no._interactions_videoM8d)
AIC(no._interactions_videoM8d)
plot(no._interactions_videoM8d)

# R-squared
Model_R2no._interactions_videoM8d <- with(summary(no._interactions_videoM8d), 1 - deviance/null.deviance)
Model_R2no._interactions_videoM8d

pseudo.R2_no._interactions_videoM8d <- (no._interactions_videoM8d$null.deviance - no._interactions_videoM8d$deviance) /
  no._interactions_videoM8d$null.deviance
pseudo.R2_no._interactions_videoM8d

# overdispersion
overdispersion_no._interactions_videoM8d <- no._interactions_videoM8d$deviance / no._interactions_videoM8d$df.residual
overdispersion_no._interactions_videoM8d

# deviance residuals
devresid_no._interactions_videoM8d <- resid(no._interactions_videoM8d, type = "deviance")
plot(devresid_no._interactions_videoM8d ~ dfLik$CaCo_index)


### cloglog
# fails
no._interactions_videoM8e <- glm(no._interactions_video ~ Treatment
                                 + CaCo_index 
                                 ,
                                 family = quasipoisson (link = "cloglog"),
                                 data = dfLik)
summary(no._interactions_videoM8e)
AIC(no._interactions_videoM8e)
plot(no._interactions_videoM8e)

# R-squared
Model_R2no._interactions_videoM8e <- with(summary(no._interactions_videoM8e), 1 - deviance/null.deviance)
Model_R2no._interactions_videoM8e

pseudo.R2_no._interactions_videoM8e <- (no._interactions_videoM8e$null.deviance - no._interactions_videoM8e$deviance) /
  no._interactions_videoM8e$null.deviance
pseudo.R2_no._interactions_videoM8e

# overdispersion
overdispersion_no._interactions_videoM8e <- no._interactions_videoM8e$deviance / no._interactions_videoM8e$df.residual
overdispersion_no._interactions_videoM8e

# deviance residuals
devresid_no._interactions_videoM8e <- resid(no._interactions_videoM8e, type = "deviance")
plot(devresid_no._interactions_videoM8e ~ dfLik$CaCo_index)
...
pseudo.R2_no._interactions_videoM9a <- (no._interactions_videoM9a$null.deviance - no._interactions_videoM9a$deviance) /
  no._interactions_videoM9a$null.deviance
pseudo.R2_no._interactions_videoM9a
...
### log
no._interactions_videoM9b <- glm.nb(no._interactions_video ~ Treatment
                                    + CaCo_index 
 , link = "log",
                                    data = dfLik)
summary(no._interactions_videoM9b, cor = FALSE)
AIC(no._interactions_videoM9b)
plot(no._interactions_videoM9b)

# R-squared
Model_R2no._interactions_videoM9b <- with(summary(no._interactions_videoM9b), 1 - deviance/null.deviance)
Model_R2no._interactions_videoM9b

pseudo.R2_no._interactions_videoM9b <- (no._interactions_videoM9b$null.deviance - no._interactions_videoM9b$deviance) /
  no._interactions_videoM9b$null.deviance
pseudo.R2_no._interactions_videoM9b

# overdispersion
overdispersion_no._interactions_videoM9b <- no._interactions_videoM9b$deviance / no._interactions_videoM9b$df.residual
overdispersion_no._interactions_videoM9b

# deviance residuals
devresid_no._interactions_videoM9b <- resid(no._interactions_videoM9b, type = "deviance")
plot(devresid_no._interactions_videoM9b ~ dfLik$CaCo_index)

## sqrt
no._interactions_videoM9c <- glm.nb(no._interactions_video ~ Treatment
                                    + CaCo_index 
 , link = "sqrt",
                                    data = dfLik)
summary(no._interactions_videoM9c, cor = FALSE)
AIC(no._interactions_videoM9c)
plot(no._interactions_videoM9c)

# R-squared
Model_R2no._interactions_videoM9c <- with(summary(no._interactions_videoM9c), 1 - deviance/null.deviance)
Model_R2no._interactions_videoM9c

pseudo.R2_no._interactions_videoM9c <- (no._interactions_videoM9c$null.deviance - no._interactions_videoM9c$deviance) /
  no._interactions_videoM9c$null.deviance
pseudo.R2_no._interactions_videoM9c

# overdispersion
overdispersion_no._interactions_videoM9c <- no._interactions_videoM9c$deviance / no._interactions_videoM9c$df.residual
overdispersion_no._interactions_videoM9c

# deviance residuals
devresid_no._interactions_videoM9c <- resid(no._interactions_videoM9c, type = "deviance")
plot(devresid_no._interactions_videoM9c ~ dfLik$CaCo_index)
...
### Poisson for number of vegetation interactions, trial different link functions
### identity
no._interactions_all_vegM7a <- glm(no._interactions_all_veg ~ Treatment
                                   + CaCo_index 
,
                                   family = poisson (link = "identity"),
                                   data = dfLik)
summary(no._interactions_all_vegM7a)
AIC(no._interactions_all_vegM7a)
plot(no._interactions_all_vegM7a)

# R-squared
Model_R2no._interactions_all_vegM7a <- with(summary(no._interactions_all_vegM7a), 1 - deviance/null.deviance)
Model_R2no._interactions_all_vegM7a

pseudo.R2_no._interactions_all_vegM7a <- (no._interactions_all_vegM7a$null.deviance - no._interactions_all_vegM7a$deviance) /
  no._interactions_all_vegM7a$null.deviance
pseudo.R2_no._interactions_all_vegM7a

# overdispersion
overdispersion_no._interactions_all_vegM7a <- no._interactions_all_vegM7a$deviance / no._interactions_all_vegM7a$df.residual
overdispersion_no._interactions_all_vegM7a

# deviance residuals
devresid_no._interactions_all_vegM7a <- resid(no._interactions_all_vegM7a, type = "deviance")
plot(devresid_no._interactions_all_vegM7a ~ dfLik$CaCo_index)
...
pseudo.R2_no._interactions_all_vegM7b <- (no._interactions_all_vegM7b$null.deviance - no._interactions_all_vegM7b$deviance) /
  no._interactions_all_vegM7b$null.deviance
pseudo.R2_no._interactions_all_vegM7b
...
plot(devresid_no._interactions_all_vegM7b ~ dfLik$CaCo_index)

## sqrt
no._interactions_all_vegM7c <- glm(no._interactions_all_veg ~ Treatment
                                   + CaCo_index 
,
                                   family = poisson (link = "sqrt"),
                                   data = dfLik)
summary(no._interactions_all_vegM7c)
AIC(no._interactions_all_vegM7c)
plot(no._interactions_all_vegM7c)

# R-squared
Model_R2no._interactions_all_vegM7c <- with(summary(no._interactions_all_vegM7c), 1 - deviance/null.deviance)
Model_R2no._interactions_all_vegM7c

pseudo.R2_no._interactions_all_vegM7c <- (no._interactions_all_vegM7c$null.deviance - no._interactions_all_vegM7c$deviance) /
  no._interactions_all_vegM7c$null.deviance
pseudo.R2_no._interactions_all_vegM7c

# overdispersion
overdispersion_no._interactions_all_vegM7c <- no._interactions_all_vegM7c$deviance / no._interactions_all_vegM7c$df.residual
overdispersion_no._interactions_all_vegM7c

# deviance residuals
devresid_no._interactions_all_vegM7c <- resid(no._interactions_all_vegM7c, type = "deviance")
plot(devresid_no._interactions_all_vegM7c ~ dfLik$CaCo_index)




no._interactions_all_vegM8a <- glm(no._interactions_all_veg ~ Treatment
                                   + CaCo_index 
                                   ,
                                   family = quasipoisson (link = "identity"),
                                   data = dfLik)
summary(no._interactions_all_vegM8a)
AIC(no._interactions_all_vegM8a)
plot(no._interactions_all_vegM8a)

# R-squared
Model_R2no._interactions_all_vegM8a <- with(summary(no._interactions_all_vegM8a), 1 - deviance/null.deviance)
Model_R2no._interactions_all_vegM8a

pseudo.R2_no._interactions_all_vegM8a <- (no._interactions_all_vegM8a$null.deviance - no._interactions_all_vegM8a$deviance) /
  no._interactions_all_vegM8a$null.deviance
pseudo.R2_no._interactions_all_vegM8a

# overdispersion
overdispersion_no._interactions_all_vegM8a <- no._interactions_all_vegM8a$deviance / no._interactions_all_vegM8a$df.residual
overdispersion_no._interactions_all_vegM8a

# deviance residuals
devresid_no._interactions_all_vegM8a <- resid(no._interactions_all_vegM8a, type = "deviance")
plot(devresid_no._interactions_all_vegM8a ~ dfLik$CaCo_index)

### log
no._interactions_all_vegM8b <- glm(no._interactions_all_veg ~ Treatment
                                   + CaCo_index 
                                   ,
                                   family = quasipoisson (link = "log"),
                                   data = dfLik)
summary(no._interactions_all_vegM8b)
AIC(no._interactions_all_vegM8b)
plot(no._interactions_all_vegM8b)

# R-squared
Model_R2no._interactions_all_vegM8b <- with(summary(no._interactions_all_vegM8b), 1 - deviance/null.deviance)
Model_R2no._interactions_all_vegM8b

pseudo.R2_no._interactions_all_vegM8b <- (no._interactions_all_vegM8b$null.deviance - no._interactions_all_vegM8b$deviance) /
  no._interactions_all_vegM8b$null.deviance
pseudo.R2_no._interactions_all_vegM8b

# overdispersion
overdispersion_no._interactions_all_vegM8b <- no._interactions_all_vegM8b$deviance / no._interactions_all_vegM8b$df.residual
overdispersion_no._interactions_all_vegM8b

# deviance residuals
devresid_no._interactions_all_vegM8b <- resid(no._interactions_all_vegM8b, type = "deviance")
plot(devresid_no._interactions_all_vegM8b ~ dfLik$CaCo_index)

### logit
# fails
no._interactions_all_vegM8c <- glm(no._interactions_all_veg ~ Treatment
                                   + CaCo_index 
                                   ,
                                   family = quasipoisson (link = "logit"),
                                   data = dfLik)
summary(no._interactions_all_vegM8c)
AIC(no._interactions_all_vegM8c)
plot(no._interactions_all_vegM8c)

# R-squared
Model_R2no._interactions_all_vegM8c <- with(summary(no._interactions_all_vegM8c), 1 - deviance/null.deviance)
Model_R2no._interactions_all_vegM8c

pseudo.R2_no._interactions_all_vegM8c <- (no._interactions_all_vegM8c$null.deviance - no._interactions_all_vegM8c$deviance) /
  no._interactions_all_vegM8c$null.deviance
pseudo.R2_no._interactions_all_vegM8c

# overdispersion
overdispersion_no._interactions_all_vegM8c <- no._interactions_all_vegM8c$deviance / no._interactions_all_vegM8c$df.residual
overdispersion_no._interactions_all_vegM8c

# deviance residuals
devresid_no._interactions_all_vegM8c <- resid(no._interactions_all_vegM8c, type = "deviance")
plot(devresid_no._interactions_all_vegM8c ~ dfLik$CaCo_index)

### probit
# fails
no._interactions_all_vegM8d <- glm(no._interactions_all_veg ~ Treatment
                                   + CaCo_index 
                                   ,
                                   family = quasipoisson (link = "probit"),
                                   data = dfLik)
summary(no._interactions_all_vegM8d)
AIC(no._interactions_all_vegM8d)
plot(no._interactions_all_vegM8d)

# R-squared
Model_R2no._interactions_all_vegM8d <- with(summary(no._interactions_all_vegM8d), 1 - deviance/null.deviance)
Model_R2no._interactions_all_vegM8d

pseudo.R2_no._interactions_all_vegM8d <- (no._interactions_all_vegM8d$null.deviance - no._interactions_all_vegM8d$deviance) /
  no._interactions_all_vegM8d$null.deviance
pseudo.R2_no._interactions_all_vegM8d

# overdispersion
overdispersion_no._interactions_all_vegM8d <- no._interactions_all_vegM8d$deviance / no._interactions_all_vegM8d$df.residual
overdispersion_no._interactions_all_vegM8d

# deviance residuals
devresid_no._interactions_all_vegM8d <- resid(no._interactions_all_vegM8d, type = "deviance")
plot(devresid_no._interactions_all_vegM8d ~ dfLik$CaCo_index)


### cloglog
# fails
no._interactions_all_vegM8e <- glm(no._interactions_all_veg ~ Treatment
                                   + CaCo_index 
                                   ,
                                   family = quasipoisson (link = "cloglog"),
                                   data = dfLik)
summary(no._interactions_all_vegM8e)
AIC(no._interactions_all_vegM8e)
plot(no._interactions_all_vegM8e)

# R-squared
Model_R2no._interactions_all_vegM8e <- with(summary(no._interactions_all_vegM8e), 1 - deviance/null.deviance)
Model_R2no._interactions_all_vegM8e

pseudo.R2_no._interactions_all_vegM8e <- (no._interactions_all_vegM8e$null.deviance - no._interactions_all_vegM8e$deviance) /
  no._interactions_all_vegM8e$null.deviance
pseudo.R2_no._interactions_all_vegM8e

# overdispersion
overdispersion_no._interactions_all_vegM8e <- no._interactions_all_vegM8e$deviance / no._interactions_all_vegM8e$df.residual
overdispersion_no._interactions_all_vegM8e

# deviance residuals
devresid_no._interactions_all_vegM8e <- resid(no._interactions_all_vegM8e, type = "deviance")
plot(devresid_no._interactions_all_vegM8e ~ dfLik$CaCo_index)


### Negative binomial for number of vegetation interactions, trial different link functions
library(MASS)

### identity
no._interactions_all_vegM9a <- glm.nb(no._interactions_all_veg ~ Treatment
                                      + CaCo_index 
                                      , link = "identity",
                                      data = dfLik)
summary(no._interactions_all_vegM9a, cor = FALSE)
AIC(no._interactions_all_vegM9a)
plot(no._interactions_all_vegM9a)

# R-squared
Model_R2no._interactions_all_vegM9a <- with(summary(no._interactions_all_vegM9a), 1 - deviance/null.deviance)
Model_R2no._interactions_all_vegM9a

pseudo.R2_no._interactions_all_vegM9a <- (no._interactions_all_vegM9a$null.deviance - no._interactions_all_vegM9a$deviance) /
  no._interactions_all_vegM9a$null.deviance
pseudo.R2_no._interactions_all_vegM9a

# overdispersion
overdispersion_no._interactions_all_vegM9a <- no._interactions_all_vegM9a$deviance / no._interactions_all_vegM9a$df.residual
overdispersion_no._interactions_all_vegM9a

# deviance residuals
devresid_no._interactions_all_vegM9a <- resid(no._interactions_all_vegM9a, type = "deviance")
plot(devresid_no._interactions_all_vegM9a ~ dfLik$CaCo_index)
...
pseudo.R2_no._interactions_all_vegM9b <- (no._interactions_all_vegM9b$null.deviance - no._interactions_all_vegM9b$deviance) /
  no._interactions_all_vegM9b$null.deviance
pseudo.R2_no._interactions_all_vegM9b
...
## sqrt
no._interactions_all_vegM9c <- glm.nb(no._interactions_all_veg ~ Treatment
                                      + CaCo_index 
                                      , link = "sqrt",
                                      data = dfLik)
summary(no._interactions_all_vegM9c, cor = FALSE)
AIC(no._interactions_all_vegM9c)
plot(no._interactions_all_vegM9c)

# R-squared
Model_R2no._interactions_all_vegM9c <- with(summary(no._interactions_all_vegM9c), 1 - deviance/null.deviance)
Model_R2no._interactions_all_vegM9c

pseudo.R2_no._interactions_all_vegM9c <- (no._interactions_all_vegM9c$null.deviance - no._interactions_all_vegM9c$deviance) /
  no._interactions_all_vegM9c$null.deviance
pseudo.R2_no._interactions_all_vegM9c

# overdispersion
overdispersion_no._interactions_all_vegM9c <- no._interactions_all_vegM9c$deviance / no._interactions_all_vegM9c$df.residual
overdispersion_no._interactions_all_vegM9c

# deviance residuals
devresid_no._interactions_all_vegM9c <- resid(no._interactions_all_vegM9c, type = "deviance")
plot(devresid_no._interactions_all_vegM9c ~ dfLik$CaCo_index)
